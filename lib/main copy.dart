...
class _FinanceTrackerHomeState extends State<FinanceTrackerHome> {
            ...
            children: [
              Expanded(
                child: _buildSummaryCard(
                  'Income',
                  '$curr${totalIncome.toStringAsFixed(2)}',
                  Colors.green,
                ),
              ),
              const SizedBox(width: 12),
              Expanded(
                child: _buildSummaryCard(
                  'Expenses',
                  '$curr${totalExpenses.toStringAsFixed(2)}',
                  Colors.red,
                ),
              ),
              const SizedBox(width: 12),
              Expanded(
                child: _buildSummaryCard(
                  'Balance',
                  '$curr${balance.toStringAsFixed(2)}',
              ...
              children: [
                Text('Recent Transactions',
                    style: TextStyle(
                        ...
                        color: textColor)),
                const SizedBox(height: 12),
                ...filtered.reversed.map((t) => _buildTransactionTile(t, curr)),
              ],
            ),
          ),
        ],
            ...
            child: Column(
              ...
              children: [
                ...
                _buildSummaryRow('Total Expenses',
                    '$curr${totalExpenses.toStringAsFixed(2)}', Colors.red, textColor),
                const SizedBox(height: 8),
            ...
            child: Column(
              ...
              children: [
                ...
                ...incomeByCategory.entries.map((e) =>
                    _buildCategoryBar(e.key, e.value, totalIncome, textColor)),
              ],
            ),
          ),
          const SizedBox(height: 20),
              ...
              children: [
                Text('Expenses by Category',
                    style: TextStyle(
                        ...
                        color: textColor)),
                const SizedBox(height: 12),
                ...expensesByCategory.entries.map((e) =>
                    _buildCategoryBar(e.key, e.value, totalExpenses, textColor)),
              ],
            ),
          ),
        ],
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 8),
                _buildProfileRow('Balance', '$curr${balance.toStringAsFixed(2)}',
                    textColor),
              ],
            ),
          ),
            ...
            child: Column(
              ...
              children: [
                ...
                ...expensesByCategory.keys.map((cat) {
                  ...
                  final percentage =
                      budget > 0 ? (spent / budget).toDouble() : 0.0;
  ...
  Widget _buildTransactionTile(Transaction t, String curr) {
    return Padding(
      padding: const EdgeInsets.only(bottom: 12),
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
  ...
  Widget _buildCategoryBar(
      String category, double amount, double total, Color textColor) {
